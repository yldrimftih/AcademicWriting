...
\begin{figure}[htbp]
    \centerline{\includegraphics{fig1-four-switch-buck-boost-converter.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics{fig10.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics{fig11.png}}
    \caption{Line regulation at single mode operation}
    \label{fig11}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics{fig12.png}}
    \caption{Line regulation at multimode operation}
    \label{fig12}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics{fig13.png}}
    \caption{Load regulation at single mode operation}
    \label{fig13}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics{fig14.png}}
